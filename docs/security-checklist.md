...
- Confirm RLS is enabled on `stage_predictions`.
...
- Confirm stage predictions are one per user per stage, locked at the first UTC kickoff, and regular users cannot update scoring fields.
